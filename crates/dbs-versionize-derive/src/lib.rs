...
//use crate::descriptors::{enum_desc::EnumDescriptor, struct_desc::StructDescriptor};
use crate::descriptors::struct_desc::StructDescriptor;
...
pub fn impl_versionize(input: TokenStream) -> proc_macro::TokenStream {
    ...
    let serializer = quote! {
        version_map.set_crate_version(env!("CARGO_PKG_NAME"), env!("CARGO_PKG_VERSION"))?;
