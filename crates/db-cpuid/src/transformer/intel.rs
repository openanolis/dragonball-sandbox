...
mod test {
    ...
    fn test_update_perf_mon_entry() {
        ...
        assert_eq!(entry.ebx.read_bit(ebx::CORE_CYCLES_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::INST_RETIRED_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::REF_CYCLES_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::LLC_REF_BITINDEX), true);
        assert_eq!(entry.ebx.read_bit(ebx::LLC_MISSES_BITINDEX), true);
        assert_eq!(entry.ebx.read_bit(ebx::BR_INST_RETIRED_BITINDEX), true);
        assert_eq!(entry.ebx.read_bit(ebx::BR_MIS_RETIRED_BITINDEX), true);
        ...
        assert_eq!(entry.ebx.read_bit(ebx::INST_RETIRED_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::REF_CYCLES_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::LLC_REF_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::LLC_MISSES_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::BR_INST_RETIRED_BITINDEX), false);
        assert_eq!(entry.ebx.read_bit(ebx::BR_MIS_RETIRED_BITINDEX), false);
    }
